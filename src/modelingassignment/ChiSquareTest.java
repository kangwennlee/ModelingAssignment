...
public class ChiSquareTest {
    ...
    public static double getCriticalValue(int[] intervalCount, double significanceLevel){
        ...
        if (numOfInterval == 1){
            if(significanceLevel == 0.1) return 2.71;
            else if(significanceLevel == 0.05) return 3.84;
            else if(significanceLevel == 0.01) return 6.63;
        }else if (numOfInterval == 2){
            if(significanceLevel == 0.1) return 4.61;
            else if(significanceLevel == 0.05) return 5.99;
            else if(significanceLevel == 0.01) return 9.21;
        }else if (numOfInterval == 3){
            if(significanceLevel == 0.1) return 6.25;
            else if(significanceLevel == 0.05) return 7.81;
            else if(significanceLevel == 0.01) return 11.34;
        }else if (numOfInterval == 4){
            if(significanceLevel == 0.1) return 7.78;
            else if(significanceLevel == 0.05) return 9.49;
            else if(significanceLevel == 0.01) return 13.28;
        }else if (numOfInterval == 5){
            if(significanceLevel == 0.1) return 9.2;
            else if(significanceLevel == 0.05) return 11.1;
            else if(significanceLevel == 0.01) return 15.1;
        }else if (numOfInterval == 6){
            if(significanceLevel == 0.1) return 10.6;
            else if(significanceLevel == 0.05) return 12.6;
            else if(significanceLevel == 0.01) return 16.8;
        }else if (numOfInterval == 7){
            if(significanceLevel == 0.1) return 12.0;
            else if(significanceLevel == 0.05) return 14.1;
            else if(significanceLevel == 0.01) return 18.5;
        }else if (numOfInterval == 8){
            if(significanceLevel == 0.1) return 13.4;
            else if(significanceLevel == 0.05) return 15.5;
            else if(significanceLevel == 0.01) return 20.1;
        }else if (numOfInterval == 9){
            if(significanceLevel == 0.1) return 14.7;
            else if(significanceLevel == 0.05) return 16.9;
            else if(significanceLevel == 0.01) return 21.7;
        }
        else if (numOfInterval == 10){
            if(significanceLevel == 0.1) return 16.0;
            else if(significanceLevel == 0.05) return 18.3;
            else if(significanceLevel == 0.01) return 23.2;
        }
        else if (numOfInterval == 20){
            if(significanceLevel == 0.1) return 28.4;
            else if(significanceLevel == 0.05) return 31.4;
            else if(significanceLevel == 0.01) return 37.6;
        }else if (numOfInterval == 30){
            if(significanceLevel == 0.1) return 40.3;
            else if(significanceLevel == 0.05) return 43.8;
            else if(significanceLevel == 0.01) return 50.9;
        }else if (numOfInterval == 40){
            if(significanceLevel == 0.1) return 51.8;
            else if(significanceLevel == 0.05) return 55.8;
            else if(significanceLevel == 0.01) return 63.7;
        }else if (numOfInterval == 50){
            if(significanceLevel == 0.1) return 63.2;
            else if(significanceLevel == 0.05) return 67.5;
            else if(significanceLevel == 0.01) return 76.2;
        }
