...
public class P2example {
    ...
    public static void main(String[] args) {
        interArrivalTime = Acceptance.generateInterarrivalTime(200);
        serviceTime = Acceptance.generateServiceTime(200);
        initialize();
        simulate();
        report();
    }
    ...
    public static void initialize() {
        ...
        time_arrival = new double[Q_LIMIT + 1];
        ...
        arrival_time = new LinkedList<Integer>();
        service_time = new LinkedList<Integer>();
